...
if queue:
  ...
  QAnim Object List = /STREAMLINE:Streamline Neg Y 40,/STREAMLINE:Streamline Y 0
  QAnim Frames = 100
  QAnim MPEG Filename = {}/Back Left Streamline Animation.mp4
  QAnim Save MPEG = On
  QAnim Looping = Loop
...
for num in range(1,queue):
  ...
  results1.SendCommand(Command="""# Sending visibility action from ViewUtilities
  >show /STREAMLINE:Streamline Y 0, view=/VIEW:View 1""")
  results1.SendCommand(Command="> autolegend plot= view=VIEW:View 1")
